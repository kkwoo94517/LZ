...
public class ScrollSnapRect : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
{
    ...
    //public StageSelectUIControl stageSelectUIControl;
    ...
    private bool _showPageSelection = true;
    ...
    void Start()
    {
        ...
        //stageSelectUIControl.ShowCurrentChapterInfo();
        //SetPageSelection(GameManager.instance.dataManager.currentChapter);
        //OnLerpToPage(GameManager.instance.dataManager.currentChapter);
    }
    ...
    void Update()
    {
        ...
        if (_lerp)
        {
            ...
            float decelerate = Mathf.Min(decelerationRate * Time.deltaTime, 0.8f);
            _container.anchoredPosition = Vector2.Lerp(_container.anchoredPosition, _lerpTo, decelerate);
            // time to stop lerping?
            //Debug.Log(Vector2.SqrMagnitude(_container.anchoredPosition - _lerpTo));
    ...
    private void SetPagePositions()
    {
        ...
        {
            Transform childTemp = _container.GetChild(i);

            RectTransform child = childTemp.GetComponent<RectTransform>();
    ...
    public void OnLerpToPage(int aPageIndex)
    {
        //stageSelectUIControl.HideChapterInfo();
        aPageIndex = Mathf.Clamp(aPageIndex, 0, _pageCount - 1);
        _lerpTo = _pagePositions[aPageIndex];
        _lerp = true;
        _currentPage = aPageIndex;
    ...
    public void NextScreen()
    {
        ...
        //stageSelectUIControl.currentChapter = _currentPage;
    }
